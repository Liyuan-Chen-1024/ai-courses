...
def plot_part2(image, r, c, response_map_resized, response_map, winW, winH):
    ...
    im = ax1.imshow(image)
    # (r, c) is the center of rectangle, (c - winW // 2, r - winH // 2) is left lower corner.
    # patches.Rectangle extends from xy[0] to xy[0] + width in x-direction, from xy[1] to xy[1] + height in y-direction.
    # Note: matlibplot: y direction from upper to lower!!!
